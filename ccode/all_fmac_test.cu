...
// ===== dtype 名字映射 =====
const char* get_dtype_name(int dtype){
    switch(dtype){
        case 1: return "FP16";
        case 2: return "BF16";
        case 3: return "TF32";
        case 7: return "MXFP8E4M3";
        case 8: return "MXFP8E5M2";
        case 9: return "NVFP4";
        case 10: return "MXFP4";
        case 11: return "MXFP6E2M3";
        case 12: return "MXFP6E3M2";
        case 13: return "FP8E4M3";
        case 14: return "FP8E5M2";
        case 15: return "FP6E2M3";
        case 16: return "FP6E3M2";
        case 17: return "MXFP4E2M1";
        case 18: return "FP4E2M1";
...
int main(int argc, char* argv[]) {
    ...
    int num_types = sizeof(float_dtypes) / sizeof(int);

    if (regendata) {

        for (int t = 0; t < num_types; t++) {

            int dtype = float_dtypes[t];
            const char* dtype_name = get_dtype_name(dtype);
            ...
            for(int vecnum = 0; vecnum < total_vecnum; vecnum++){
                ...
                int result = gen_data_file(df, bitsize, dtype, is_rand, float_type, 0);
            ...
            // ===== 只输出一行结果 =====
            if (all_correct) {
                printf("%s Format test %d th, the result is right\n",
                       dtype_name, total_vecnum);
            } else {
                printf("%s Format test %d th , the result is wrong\n",
                       dtype_name, fail_index);
            }
